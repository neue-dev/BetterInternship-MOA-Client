...
export const appControllerGetApi = (signal?: AbortSignal) => {
  return preconfiguredAxiosFunction<void>({ url: `/api`, method: "GET", signal });
};
...
export const appControllerTestEmail = (signal?: AbortSignal) => {
  return preconfiguredAxiosFunction<void>({ url: `/api/email-test`, method: "POST", signal });
};
...
export const appControllerGetHealth = (signal?: AbortSignal) => {
  return preconfiguredAxiosFunction<void>({ url: `/api/health`, method: "GET", signal });
};
